...
public class LineGridStrategyTest {
  ...
  public void testParseSpacingAndOrigin() throws Throwable {
    ...
    checkFeature(
        layerData, idToFeature.get("grid.y.1"), new Coordinate(100, 110), new Coordinate(140, 110));
    checkFeature(
        layerData, idToFeature.get("grid.x.1"), new Coordinate(110, 100), new Coordinate(110, 140));
    checkFeature(
        layerData, idToFeature.get("grid.x.2"), new Coordinate(130, 100), new Coordinate(130, 140));
  }
  ...
  public void testParseNumLines() throws Throwable {
    ...
    Map<String, SimpleFeature> idToFeature = idToFeatureMap(features);
    checkFeature(
        layerData, idToFeature.get("grid.x.1"), new Coordinate(120, 90), new Coordinate(120, 132));
    checkFeature(
        layerData, idToFeature.get("grid.x.2"), new Coordinate(130, 90), new Coordinate(130, 132));
    checkFeature(
        layerData, idToFeature.get("grid.x.3"), new Coordinate(140, 90), new Coordinate(140, 132));
    checkFeature(
        layerData, idToFeature.get("grid.y.1"), new Coordinate(110, 104), new Coordinate(150, 104));
    checkFeature(
        layerData, idToFeature.get("grid.y.2"), new Coordinate(110, 118), new Coordinate(150, 118));
  }
